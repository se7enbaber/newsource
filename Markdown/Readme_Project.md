...
4. **Nâng cấp Giao diện Frontend (Next.js) & Component UX/UI:**
   ...
   - **Giao diện Vibe-centric (Gen Z Theme):** Cập nhật toàn bộ theme sang phong cách hiện đại, sử dụng bảng màu Vibrant Purple (`#7f13ec`) & Mint Teal (`#2bd4bd`) cùng font chữ Space Grotesk. Bổ sung các Custom CSS classes để tạo nút bấm Gradient ("Primary Vibe") và các Badge trạng thái sinh động ("Crushing it", "Need Coffee", "Vibing") phù hợp với người dùng Gen Z.
